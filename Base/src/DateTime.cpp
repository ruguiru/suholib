...
{
	return static_cast<long long>( ( GetDaysFromFirstYear( _year, _month, _day ) * static_cast<long long>( 86400 ) ) + static_cast<long long>( _hour ) * 3600 + static_cast<long long>( _min ) * 60 + _sec );
}
